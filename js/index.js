...
$(document).ready(function () {
    ...
    function updateDisplay(city) {
      ...
      if (city.weather[0].description == "clear sky") {
        ...
        img.src = 'images/scattered_clouds.jpg';
      }
        ...
        img.src = 'images/broken_clouds.jpg';
      }
        ...
        img.src = 'images/shower_rain.jpg';
      }
        ...
        img.src = 'images/thunderstorm_with_light_rain.jpg';
      }
      else {
        var img = new Image();
        img.onload = function () {
